    ...
    if len(zanyat) >= 5:
        ...
        if but5["bg"]=="red":
            if but1["bg"]=="red" and but9["bg"]=="red":
                pobeda("red")
            if but2["bg"]=="red" and but8["bg"]=="red":
                pobeda("red")
            if but3["bg"]=="red" and but7["bg"]=="red":
                pobeda("red")
            if but4["bg"]=="red" and but6["bg"]=="red":
                pobeda("red")
        if but1["bg"]=="red":
            if but2["bg"]=="red" and but3["bg"]=="red":
                pobeda("red")
            if but4["bg"]=="red" and but7["bg"]=="red":
                pobeda("red")
        if but9["bg"]=="red":
            if but6["bg"]=="red" and but3["bg"]=="red":
                pobeda("red")
            if but8["bg"]=="red" and but7["bg"]=="red":
                pobeda("red")
        #3 blue
        if but5["bg"]=="blue":
            if but1["bg"]=="blue" and but9["bg"]=="blue":
                pobeda("blue")
            if but2["bg"]=="blue" and but8["bg"]=="blue":
                pobeda("blue")
            if but3["bg"]=="blue" and but7["bg"]=="blue":
                pobeda("blue")
            if but4["bg"]=="blue" and but6["bg"]=="blue":
                pobeda("blue")
        if but1["bg"]=="blue":
            if but2["bg"]=="blue" and but3["bg"]=="blue":
                pobeda("blue")
            if but4["bg"]=="blue" and but7["bg"]=="blue":
                pobeda("blue")
        if but9["bg"]=="blue":
            if but6["bg"]=="blue" and but3["bg"]=="blue":
                pobeda("blue")
            if but8["bg"]=="blue" and but7["bg"]=="blue":
                pobeda("blue")
